 ...
 */
export class OpenRouterAnalysisAdapter implements BackendLlmAnalysisAdapter {
    /**
     ...
     */
    readonly model = OPENROUTER_SERVER_MODEL;
     ...
     */
    private constructor(options: OpenRouterAnalysisAdapterOptions) {
    ...
    static create(
        ...
        return new OpenRouterAnalysisAdapter(options);
    }
     ...
     * @returns Configured server analysis adapter.
     */
    static createFromEnvironment(): OpenRouterAnalysisAdapter {
        return OpenRouterAnalysisAdapter.create({
                    ...
                    body: JSON.stringify({
                        ...
                        messages: [
                            ...
                            },
                            {
                                role: 'user',
                                content:
                                    OpenRouterAnalysisAdapter.buildUserContent(
                                        input,
                                    ),
                            },
                        ],
    ...
    private static parseResponse(
        ...
        return {
            ...
            usage: OpenRouterAnalysisAdapter.parseUsage(value.usage),
        };
    }
