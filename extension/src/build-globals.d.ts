 ...
 */
declare const __TOPSKIP_INCLUDE_DEV_LOCAL__: boolean;

/**
 * Compile-time gate for detailed caption acquisition diagnostics.
 */
declare const __TOPSKIP_CAPTION_CAPTURE_VERBOSE_LOGS__: boolean;
 ...
 */
declare const __TOPSKIP_INCLUDE_CHROME_BUILTIN__: boolean;
