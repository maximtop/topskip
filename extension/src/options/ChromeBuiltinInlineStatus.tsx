        ...
        return (
            <Alert color="success" variant="light">
                <Group gap="xs" align="center">
                    ...
                    <Text size="sm">
                        Gemini Nano is ready — analysis runs entirely on your
                        device.
                    </Text>
                </Group>
            </Alert>
    ...
    if (state.matches('downloadable')) {
        return (
            <Alert color="blue" variant="light">
                <Group gap="xs" justify="space-between" align="center">
                    <Text size="sm">
                        Gemini Nano (~2 GB) needs to download first. Runs
                        on-device — no data leaves your computer.
                    </Text>
                    <Button
                        size="xs"
    ...
    if (state.matches('unavailable')) {
        return (
            <Alert color="gray" variant="light">
                <Text size="sm">
                    Not available on this device. Requires Chrome 138+, 22 GB
                    storage, 4 GB+ VRAM or 16 GB RAM.
                </Text>
            </Alert>
        );
    }
