        ...
        <Stack gap="md">
          <Stack gap={4}>
            ...
            <Text size="sm" c="dimmed">
              Choose the default cloud model used when OpenRouter is the active
              provider.
            </Text>
          </Stack>
          <Select
          ...
          <TextInput
            ...
            rightSection={
              <ActionIcon
                variant="subtle"
                aria-label={
                  props.apiKeyVisible ? 'Hide API key' : 'Show API key'
                }
                onClick={() => {
      ...
      <Paper p="lg" radius="xl">
        <Stack gap="md">
          <Stack gap={4}>
            ...
            <Text size="sm" c="dimmed">
              Save additional OpenRouter model slugs if you want quick access to
              providers outside the built-in preset list.
            </Text>
          </Stack>
          ...
          <Group align="flex-end" wrap="nowrap" gap="sm">
            <TextInput
              ...
              onChange={(event) => {
                props.onNewModelDraftChange(event.currentTarget.value);
              }}
            />
            <Button
                  ...
                  <Group justify="space-between" wrap="nowrap" gap="md">
                    <Stack gap={1} style={{ flex: 1 }}>
                      <Group gap={6}>
                        ...
                        {props.unverifiedModels.has(slug) ? (
