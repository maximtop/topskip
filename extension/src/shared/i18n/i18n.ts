...
export class I18n {
    ...
    async init(): Promise<void> {
        try {
            this.currentLocale = await this.translationService.loadLocaleData();
        } catch {
    ...
    getMessage(key: string): string {
        ...
        return this.translationService.getMessage(this.currentLocale, key);
    }
    ...
    getUILanguage(): string {
        ...
        return this.translationService.getUILanguage(this.currentLocale);
    }
