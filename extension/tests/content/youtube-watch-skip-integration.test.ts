...
describe('onTimeUpdate skip pipeline integration', () => {
  ...
  it('FR-003: does not skip when enabled is' +
  ...
  it('FR-004: backward seek resets fired indices' +
    ' (pure function)', () => {
  ...
  it('FR-004: backward seek resets via onSeeked' +
  ...
  it('FR-005: SPA navigation resets are handled' +
  ...
  it('FR-011: after skip, lastTime should be' +
